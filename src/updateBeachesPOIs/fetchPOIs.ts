...
const URL = `https://api.tomtom.com/search/2/nearbySearch/.json?lat=%LAT%&lon=%LNG%&countrySet=ES&limit=25&radius=10000&language=es-ES&view=Unified&relatedPois=off&key=${API_KEY}`;
